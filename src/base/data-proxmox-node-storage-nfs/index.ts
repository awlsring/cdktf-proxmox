...
export interface DataProxmoxNodeStorageNfsConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly filters?: DataProxmoxNodeStorageNfsFilters[] | cdktf.IResolvable;
}
...
export class DataProxmoxNodeStorageNfsFiltersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataProxmoxNodeStorageNfsFilters | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataProxmoxNodeStorageNfsFilters | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataProxmoxNodeStorageNfsFiltersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataProxmoxNodeStorageNfsFiltersOutputReference {
    return new DataProxmoxNodeStorageNfsFiltersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataProxmoxNodeStorageNfsNodeStorageNfs {
}
...
export class DataProxmoxNodeStorageNfsNodeStorageNfsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataProxmoxNodeStorageNfsNodeStorageNfs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }
...
export class DataProxmoxNodeStorageNfsNodeStorageNfsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataProxmoxNodeStorageNfsNodeStorageNfsOutputReference {
    return new DataProxmoxNodeStorageNfsNodeStorageNfsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataProxmoxNodeStorageNfs extends cdktf.TerraformDataSource {
  ...
  * @param options DataProxmoxNodeStorageNfsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataProxmoxNodeStorageNfsConfig = {}) {
    super(scope, id, {
  ...
  public putFilters(value: DataProxmoxNodeStorageNfsFilters[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      filters: cdktf.listMapper(dataProxmoxNodeStorageNfsFiltersToTerraform, false)(this._filters.internalValue),
    };
  }
}
